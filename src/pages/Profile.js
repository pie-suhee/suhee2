          ...
          <div className="profile">
            ...
            <div className="section introduce type2">
              ...
              <div className="info">
                <ul>
                  <li>
                    <div className="keyword">웹 퍼블리셔/프론트엔드 개발자로서의 지향점</div>
                    <div className="content">
                      사용자 중심의 개선과 반복을 통해 완성도 높은 결과물을 만들어가는 과정 속에서, 상황에 맞는 기술을 적용하여 편안하고 깔끔한 UX를 제공하는 웹 퍼블리셔/프론트엔드 개발자가 되는 것을 목표로 하고 있습니다.
                    </div>
                  </li>
                  <li>
                    <div className="keyword">명확하게 소통하는 동료</div>
                    <div className="content">
                      중의적으로 해석될 수 있는 애니메이션 표현을 명확한 기준으로 분류·정리해, 고객사와 개발 간 소통 오류를 줄인 경험이 있습니다. 이 개선은 업무 효율을 높였습니다. 이 경험을 계기로, 앞으로도 사소한 오해라도 놓치지 않고 세심하게 소통하며 협업의 완성도를 높이는 개발자가 되고자 합니다.
                    </div>
                  </li>
                  <li>
                    <div className="keyword">장점</div>
                    <div className="content">
                      사람들과의 협업 속에서 균형을 잘 맞추는 편입니다. 주도적으로 방향을 잡되, 타인의 의견도 존중하고 조율하는 과정에서 오히려 에너지를 얻습니다. 이전 직장에서는 신입 교육을 맡아 개발 흐름을 정리해주거나, 팀원들이 코드를 더 쉽게 이해할 수 있도록 문서화하는 일을 도맡아 했습니다. 이런 팀 전체의 성장을 도울 수 있는 일에 큰 보람을 느낍니다.
                    </div>
                  </li>
                  <li>
                    <div className="keyword">단점</div>
                    <div className="content">
                      새로운 것을 배우고 시도하는 걸 좋아하다 보니, 때로는 ‘지금 꼭 필요한가?’라는 질문을 놓칠 때도 있습니다. 그래서 요즘은 ‘내가 왜 이걸 하고 있지?’를 스스로 점검하며, 목표에 집중하는 습관을 들이고 있습니다.
                    </div>
                  </li>
                </ul>
              </div>
